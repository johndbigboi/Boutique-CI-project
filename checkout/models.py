import uuid  # UUID which will be used to generate the order number.
...
class Order(models.Model):
    ...
    # auto now add attribute on the date field
    ...
    def _generate_order_number(self):
        ...
        which will just generate a random string of 32 characters 
